...
x509name::x509name() { xn = X509_NAME_new(); }
...
unsigned x509name::hashNum() const { return X509_NAME_hash(xn) & 0x7fffffffL; }
...
int x509name::entryCount() const { return X509_NAME_entry_count(xn); }
...
X509_NAME* x509name::get() const { return X509_NAME_dup(xn); }

const X509_NAME* x509name::get0() const { return xn; }
