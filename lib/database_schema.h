...
schemas[0]
    ...
    << "CREATE TABLE items("
       ...
       "date " DB_DATE
       ", "  // Time of insertion (creation/import)
    ...
    << "CREATE TABLE revocations ("
       ...
       "date " DB_DATE
       ", "  // Time of creating the revocation
       "invaldate " DB_DATE
...
schemas[5] << "ALTER TABLE settings RENAME TO __settings"
           << "CREATE TABLE settings ("
              "key_ CHAR(20) UNIQUE, "  // mySql does not like 'key' or 'option'
              "value " B64_BLOB ")"
...
schemas[6] << "ALTER TABLE items ADD del SMALLINT NOT NULL DEFAULT 0"
