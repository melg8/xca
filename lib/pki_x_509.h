...
class pki_x509 final : public pki_x509super {
 ...
 protected:
  [[nodiscard]] int sigAlg() const final;
 ...
 public:
  ...
  [[nodiscard]] bool hasExtension(int nid) const;
  ...
  [[nodiscard]] x509v3ext getExtByNid(int nid) const;
  ...
  [[nodiscard]] x509revList getRevList() const;
  ...
  [[nodiscard]] QStringList icsVEVENT_ca() const;
};
