...
class x509rev {
 ...
 public:
  ...
  x509rev(X509_REVOKED* n) { fromREVOKED(n); }
  ...
  bool operator==(const x509rev& x) const { return serial == x.serial; }
  x509rev& operator=(const x509rev& x) {
    set(x);
    return *this;
  }
  void setSerial(const a1int& i) { serial = i; }
  void setDate(const a1time& t) { date = t; }
  void setInvalDate(const a1time& t) { ivalDate = t; }
