...
#define XCA_PASSWD_ERROR() \
  XCA_WARN(QObject::tr("Password verify error, please try again"))
...
class xcaWarning {
 ...
 public:
  ...
  static void information(const QString& msg) { gui->information(msg); }
  static void warning(const QString& msg) { gui->warning(msg); }
