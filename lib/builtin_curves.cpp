...
static const QList<int> x962_curve_nids() {
  return QList<int>{
      NID_X9_62_prime192v1, NID_X9_62_prime192v2, NID_X9_62_prime192v3,
      NID_X9_62_prime239v1, NID_X9_62_prime239v2, NID_X9_62_prime239v3,
...
static const QList<int> other_curve_nids() {
  return QList<int>{NID_sect113r1,
                    NID_sect113r2,
                    NID_sect131r1,
                    NID_sect131r2,
                    NID_sect163k1,
...
#endif
    append(builtin_curve(nid, QString(curves[i].comment), BN_num_bits(order),
                         flag, type));
    EC_GROUP_free(group);
  }
  BN_free(order);
