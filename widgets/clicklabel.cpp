...
ClickLabel::ClickLabel(QWidget* parent) : DoubleClickLabel(parent) {
  QFont fnt(font());
  fnt.setBold(true);
  setFont(fnt);
...
void ClickLabel::setRed() { setColor(QColor(192, 32, 32)); }

void ClickLabel::setGreen() { setColor(QColor(32, 192, 32)); }

void ClickLabel::disableToolTip() { setToolTip(QString()); }

CopyLabel::CopyLabel(QWidget* parent) : DoubleClickLabel(parent) {
